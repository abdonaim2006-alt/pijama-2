...
export const products: Product[] = [
  // Collection Été - 2 produits
  {
    ...
    image: 'summer-light',
    collection: 'été',
    colors: ['Menthe Douce', 'Pêche', 'Jaune Pâle'],
    sizes: ['S', 'M', 'L', 'XL'],
    rating: 4.6,
    reviews: 187,
  ...
  },
  {
    ...
    image: 'linen-breeze',
    collection: 'été',
    colors: ['Blanc Écru', 'Beige Miel', 'Bleu Lagon', 'Gris Nuage'],
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    rating: 4.5,
    reviews: 143,
  ...
  // Collection Hiver - 2 produits
  {
    ...
    image: 'winter-cozy',
    collection: 'hiver',
    colors: ['Marron Chocolat', 'Gris Charbon', 'Bordeaux', 'Bleu Nuit'],
  ...
  },
  {
    ...
    collection: 'hiver',
    colors: ['Gris Argent', 'Caramel', 'Noir', 'Crème Ivoire'],
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    rating: 4.9,
    reviews: 145,
  ...
  // Collection Premium - 2 produits
  {
    ...
    image: 'silk-luxury',
    collection: 'premium',
    colors: ['Rose Poudré', 'Bleu Marine', 'Blanc Ivoire', 'Noir Profond'],
    sizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
    rating: 4.9,
    reviews: 234,
  ...
  },
  {
    ...
    collection: 'premium',
    colors: ['Blanc Pur', 'Gris Clair', 'Bleu Ciel', 'Crème'],
    sizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
    rating: 4.8,
    reviews: 456,
  ...
  // Collection Confort - 2 produits
  {
    ...
    image: 'bamboo-eco',
    collection: 'confort',
    colors: ['Vert Sauge', 'Beige Naturel', 'Gris Souris', 'Bleu Ardoise'],
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    rating: 4.8,
    reviews: 289,
  ...
  },
  {
    ...
    collection: 'confort',
    colors: ['Rose Pâle', 'Bleu Pastel', 'Lavande', 'Pêche Douce'],
    sizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
    rating: 4.7,
    reviews: 521,
